...
impl Plugin for BulletHellElite {
    fn build(&self, app: &mut App){
        app
            ...
            .add_systems(FixedUpdate, (player::sprite_movement, bullet::bullet_movement, bullet::play_collision_sound, enemy::enemy_control, player::update_player_health).run_if(in_state(GameState::Game)))
